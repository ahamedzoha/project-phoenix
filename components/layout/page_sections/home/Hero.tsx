  ...
  return (
    <section id='hero_container' className='bg-[#f4f5f9]] relative'>
      <div className='flex w-full flex-col items-start justify-center py-12 sm:flex-row sm:py-24 md:py-4  2xl:py-8 '>
        {/* text column */}
        <div
          className='mt-0 flex w-full flex-col items-start justify-center space-y-6 px-6  
        pr-0 
        md:mt-16 
        lg:mt-16 xl:py-4  
        xl:px-36
        2xl:w-2/3 5xl:mt-36 5xl:ml-96 5xl:w-1/2 5xl:py-7
        '
        >
          <h1
            className='z-20 max-w-lg font-serif text-3xl font-bold text-[#30333A] 
          md:text-5xl
          5xl:font-serif 5xl:text-6xl
          '
          >
            Full-stack Software Engineer
          </h1>
          <p className=' z-20 mt-5 text-lg text-[#80948D] md:text-2xl'>
            With 3+ Years of Experience
          </p>
          <p className='z-20 mt-5 max-w-md text-lg text-[#30333A] md:text-base'>
          ...
          {/* buttons */}
          <div className='z-20 flex w-full flex-col justify-start space-y-2 pt-6 sm:flex-row sm:space-y-0 sm:space-x-4 sm:pt-4'>
