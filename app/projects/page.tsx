      ...
      >
        {projects.map((project) => (
          <Card as='li' key={project.name}>
            <div className='relative z-10 flex h-12 w-12 items-center justify-center rounded-full border border-zinc-200 bg-white shadow-md shadow-zinc-800/5 dark:border-ink-700 dark:bg-ink-800'>
              <Image
                src={project.logo}
                alt=''
                className='h-8 w-8'
            ...
            <p className='relative z-10 mt-6 flex font-mono text-xs text-zinc-500 transition group-hover:text-accent-500 dark:text-zinc-400 dark:group-hover:text-accent-400'>
